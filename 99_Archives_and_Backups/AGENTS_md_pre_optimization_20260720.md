...
> **[MOVED TO SKILL]** All domain rules for inclusion/exclusion have been physically moved to `.agents/skills/include_exclude_pipeline/SKILL.md` to optimize the context window for downstream extraction agents.

---

## Section C: Data Extraction Rules
> **[MOVED TO SKILL]** All domain rules for data extraction have been physically moved to `.agents/skills/data_extractor/extract_measures/SKILL.md` to optimize the context window.

---

## Section D: Evidence & Documentation Rules

13. (Formerly Rule 30) **Verbatim Quote Injection for ALL Judgments:** To eliminate AI hallucination and ensure 100% auditability, whenever a paper is judged—whether `1 = Include` or `0 = Exclude`—you MUST extract and inject exact, character-for-character verbatim quotes from the PDF text into Col 16 (Notes) of `BSMA_Master_Coding_Sheet.xlsx`.
...
16. (Formerly Rule 33) **Validation Terminology Standard:** To prevent misinterpretation of AI validation results, the following terminology MUST be used consistently across all artifacts, reports, and agent outputs:
