## Special Cases: Misleading Correlation Tables (SEM)
When dealing with Structural Equation Modeling (SEM) papers, authors often include tables for **Discriminant Validity** (which compare Average Variance Extracted / AVE against correlation values).
