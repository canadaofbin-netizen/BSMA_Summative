...
- To generate a comprehensive final Match Rate Report across all 701 papers, run `python .agents/skills/include_exclude_pipeline/scripts/grade_test.py --master "path_to_master.xlsx" --test "path_to_test.xlsx"` or write a custom cross-validation script.
