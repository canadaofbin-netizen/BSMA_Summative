...
with open('g:/My Drive/UCL/BSMA/BSMA ANTIGRAVITY/scratch/preamble.txt', 'r', encoding='utf-8') as f:
    preamble = f.read()
...
with open('g:/My Drive/UCL/BSMA/BSMA ANTIGRAVITY/scratch/final_subagents_args.json', 'w', encoding='utf-8') as f:
